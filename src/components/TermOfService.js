                ...
                <div className="container">
                    <div className="card p-5">
                        <div className='mb-4'>
                            ...
                            <p className="text-md text-muted mb-3">Welcome to Mint-Sea. This document outlines the terms of service for Mint-Sea, which govern access to their website, mobile apps, and live support. It also mentions the use of their services to view, explore, and create NFTs on public blockchains.</p>
                            ...
                            <p className="text-md text-muted mb-3">Mint-Sea is a peer-to-peer web3 service that does not act as a wallet provider, exchange, broker, dealer, financial institution, payments processor, money transfer company, or creditor.</p>
                            <p className="text-md text-muted mb-3">Mint-Sea does not make any guarantees about the identity, legitimacy, functionality, or authenticity of users or NFTs on the Service. Users bear full responsibility for verifying the identity, legitimacy, and authenticity of NFTs purchased from third-party sellers.</p>
                        ...
                        <div className='mb-4'>
                            ...
                            <p className="text-md text-muted mb-3">In Mint-Sea no age limit restrict any one can vistie our services and utilize our service </p>
                        </div>
                        ...
                        <div className='mb-4'>
                            ...
                            <p className="text-md text-muted mb-3">Mint-Sea reserves the right to use and disclose Feedback without further notice or compensation, and assigns all rights, title, and interest in and to any and all Feedback to Mint-Sea.</p>
                            <p className="text-md text-muted mb-3">Mint-Sea has no ownership, custody, or control over third-party NFTs or smart contracts. The creators of these NFTs or smart contracts are exclusively responsible for the operation and functionality of their creations.</p>
                        </div>
                        ...
                        <div className='mb-4'>
                            ...
                            <p className="text-md text-muted mb-3">Mint-Sea and its service providers are not liable for any lost profits or damages arising from the use of the Service, and products. Access to and use of the Service is at the user's own discretion and risk, and they are solely responsible for any damage to their computer system or mobile device or loss of data resulting from it. Some jurisdictions limit disclaimers or limitations of liability for personal injury from consumer products, so this limitation may not apply to personal injury claims.</p>
                        </div>
                        ...
                        <div className='mb-4'>
                            ...
                            <p className="text-md text-muted mb-3">Mint-Sea reserves the right to suspend, restrict, disable, terminate, or delete your Account and/or access or use the Service at any time and for any reason. If we terminate your Account or restrict your access or use of the Service, you retain ownership of your NFTs and can still access them through public blockchains and other web3 wallets.</p>
                        </div>
                        ...
                        <div className='mb-4'>
                            ...
                            <p className="text-md text-muted mb-3">Mint-Sea is entitled to equitable relief in addition to any remedies it may have without the need for a bond, security, or proof of damages.</p>
                        </div>

                        <div className='mb-4'>
                            <p className="text-md text-muted mb-3 fw-bold">17. Survival</p>
                            <p className="text-md text-muted mb-3">Mint-Sea's other rights and remedies will continue in full force and effect despite any termination of these Terms, notwithstanding any termination.</p>
                        </div>

                        <div className='mb-4'>
                            <p className="text-md text-muted mb-3 fw-bold">18. Miscellaneous</p>
                            <p className="text-md text-muted mb-3">These Terms are the entire agreement between you and Mint-Sea relating to your access to and use of the Service. These Terms may not be transferred or assigned without Mint-Sea's prior written consent, and any failure to assert any right or provision under these Terms shall not constitute a waiver of such right or provision. The section headings used herein are for reference only and shall not have any legal effect.</p>
