              ...
              <div class="card">
                <div class="card-body py-4 py-lg-5 px-2 px-lg-4">
                  ...
                  <div className='mb-4'>
                    ...
                    <p class="text-md text-muted mb-3 fw-bold">What role does the metaverse play in web3?</p>
                    <p class="text-md text-muted mb-3">Metaverses built on web3 technology will have capabilities supported by blockchain technology, allowing users to buy NFTs of game elements and use them across multiple games. The decentralized nature of the blockchain means metaverse experiences are built to be co-created by players, not beholden to a single game developer or brand.</p>

                    <p class="text-md text-muted mb-3 fw-bold">Who owns web3?</p>
                    <p class="text-md text-muted mb-3">No one. The web3 ecosystem was created to be decentralized, which means it cannot be owned by a single entity, person, or company. It is run by a network of computers that validate transactions, making it easier to authenticate ownership without the intervention of others.</p>

                    <p class="text-md text-muted mb-3 fw-bold">Are web 3.0 and web3 the same thing?</p>
                    <p class="text-md text-muted mb-3">Web 3.0 refers to the Semantic Web, an internet of linked data, while Web3 refers to the decentralized web as described in this article.</p>
