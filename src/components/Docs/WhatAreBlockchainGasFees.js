              ...
              <div class="card">
                <div class="card-body py-4 py-lg-5 px-2 px-lg-4">
                  ...
                  <div className='mb-4'>
                    ...
                    <p class="text-md text-muted mb-3">We'll go into the purpose of gas fees, what influences them, how to avoid paying large fees, how fees vary by blockchain, and how Mint-Sea makes it simple to keep expenses low. Let's get started.</p>
                    ...
                    <p class="text-md text-muted mb-3">Mint-Sea has no control over gas fees, does not determine them, and does not receive any of the gas fees spent by platform users. They all go to network validators or miners instead.</p>
                    ...
                    <p class="text-md text-muted mb-3 fw-bold">Why use Mint-Sea for your NFT transactions?</p>
                    <p class="text-md text-muted mb-3">Mint-Sea works with several chains and has minimal gas fees. We understand that each chain has its own advantages and that they are all continually evolving, so Mint-Sea is here to provide you with a variety of options when minting, purchasing, or selling NFTs.</p>
                    {/* <p class="text-md text-muted mb-3">Mint-Sea's new protocol, Seaport, also drastically reduces gas prices for NFT transactions. Since the launch of Seaport, we've helped users save an estimated 35% on transaction gas fees.</p> */}
                    ...
                    {/* <p class="text-md text-muted mb-3">Finally, we offer free NFT creation using Lazy Minting. Mint-Sea, the largest and most diverse NFT marketplace, is here to provide you with the best range of NFTs on several blockchains.</p> */}
                    ...
                    <p class="text-md text-muted mb-3 fw-bold">Can Mint-Sea refund my gas fees?</p>
                    <p class="text-md text-muted mb-3">No, Mint-Sea cannot refund gas fees because we are not the business that receives or retains the payments. Any gas used while attempting to complete a transaction that lacks sufficient cryptocurrency is spent on that transaction and cannot be repaid.</p>

                    <p class="text-md text-muted mb-3 fw-bold">Does the buyer or seller pay gas fees on Mint-Sea?</p>
                    <p class="text-md text-muted mb-3">No, In Mint-sea you don't give any fess, If you have mint your nft and a make offer in your nft and you want to sell your nft just give any offer and the buyer will buy this nft and you will claim your funds in your wallet using are Mint-sea project. whatever you give prize for your nft you will get back same..</p>
