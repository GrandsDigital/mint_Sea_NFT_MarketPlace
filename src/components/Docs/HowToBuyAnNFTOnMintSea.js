                                    ...
                                    <ul className="list-unstyled mb-4">
                                        <li className="d-flex mb-3">
                                            ...
                                            <div className="ms-2">
                                                ...
                                                <NavLink className="text-md text-reset" to="/docs/how_to_create_an_nft_on_mintsea">How to create an NFT on Mint-Sea?</NavLink>
                                            </div>
                                        </li>
                                        <li className="d-flex mb-3">
                                            <div className="contact-icon bd-3 border-primary text-primary flex-shrink-0" style={{ width: "1.5rem", height: "1.5rem" }}>
                                            ...
                                            <div className="ms-2">
                                                <NavLink className="text-md text-reset" to="/docs/how_to_list_an_nft_for_sale_using_mintsea">How to list an NFT for sale using Mint-Sea?</NavLink>
                                            </div>
                                        </li>
                                        <li className="d-flex mb-3">
                                            <div className="contact-icon bd-3 border-primary text-primary flex-shrink-0" style={{ width: "1.5rem", height: "1.5rem" }}>
                                            ...
                                            <div className="ms-2">
                                                <NavLink className="text-md text-reset" to="/docs/how_to_buy_an_nft_on_mintsea">How to buy an NFT on Mint-Sea?</NavLink>
                                            </div>
                                        </li>
                                        <li className="d-flex mb-3">
                                            <div className="contact-icon bd-3 border-primary text-primary flex-shrink-0" style={{ width: "1.5rem", height: "1.5rem" }}>
                                            ...
                                            <div className="ms-2">
                                                <NavLink className="text-md text-reset" to="/docs/how_to_claim_funds_on_mintsea">How to claim funds on Mint-Sea?</NavLink>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="card">
                                <div class="card-body py-4 py-lg-5 px-2 px-lg-4">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <h2 class="h5 mb-0">How to create an NFT on Mint-Sea?</h2>
                                    </div>
                                    ...
                                    <div className='mb-4'>
                                        ...
                                        <p class="text-md text-muted mb-3">Create NFTs by naming it something unique and describing it. Choose a category. Set up a crypto wallet, choose a blockchain, and mint your NFTs.</p>

                                        <p class="text-md text-muted mb-3 fw-bold">Does it cost money to create an NFT?</p>
                                        <p class="text-md text-muted mb-3">No, in Mint-sea you don't give any fess.</p>

                                        <p class="text-md text-muted mb-3 fw-bold">What are the step-by-step instructions for creating an NFT on Mint-Sea?</p>
                                        <p class="text-md text-muted mb-3">Mint-Sea makes it simple and fast to create an NFT.</p>
                                        ...
                                        <p class="text-md text-muted mb-3 fw-bold">Why should I create my NFTs using Mint-Sea?</p>
                                        <p class="text-md text-muted mb-3">Mint-Sea provides creators with an easy-to-use creative process to develop NFT that helps them stand out. They distribute their NFTs to the widest possible audience, making the creation and minting process simple and straightforward for creators.</p>
