            ...
            <section className="py-5">
                <div className="container">
                    <div className="card p-5">
                        ...
                        <div className='mb-4'>
                            <p className="text-md text-muted mb-3 fw-bold">2. Use of Your Data.</p>
                            <p className="text-md text-muted mb-3 ms-3"><b>I.</b> To operate our business, deliver the Service, cater to your individual needs, and enhance the Service, we process information about and/or pertaining to you. To be more precise, we use your information to:</p>
                            <p className="text-md text-muted mb-3 ms-3"><b>II.</b> Deliver, run, and maintain the Service;</p>
                            <p className="text-md text-muted mb-3 ms-3"><b>III.</b> Enhance and assess the Service;</p>
                        ...
                        <div className='mb-4'>
                            <p className="text-md text-muted mb-3"><b>4. External Wallets.</b> You need to use a third-party wallet with public blockchain support in order to enjoy some features of our Service. The applicable terms of service and privacy policy of any third-party wallet provider will apply to your dealings with that third party.</p>
                        </div>

                        <div className='mb-4'>
                            <p className="text-md text-muted mb-3"><b>5. Your Informational Decision-Making Options.</b> Regarding how to use the information on our service, you have options:</p>
                            <p className="text-md text-muted mb-3 ms-3"><b>A.</b> Email correspondence. Periodically, we might send you emails, newsletters, or both that specifically advertise using our service or the products and services of third parties. </p>
                        </div>
                        ...
                        <div className='mb-4'>
                            <p className="text-md text-muted mb-3"><b>7. Safety.</b> We are concerned about the security of your information and employ physical, administrative, and technological precautions to ensure the integrity and security of data acquired through our Service. However, no security system is impenetrable, and we cannot guarantee the security of our own or our vendors' systems. If any information under our custody and control is compromised as a result of a breach of security, we will investigate and remediate the situation, and we may notify those individuals whose information may have been compromised in accordance with applicable laws and regulations.</p>
                            <p className="text-md text-muted mb-3">You are responsible for the security of your digital wallet, and we advise you to take the necessary precautions to ensure that it is and remains safe. Please contact your wallet provider if you detect a problem with your wallet.</p>
                        </div>
                        ...
                        <div className='mb-4'>
                            <p className="text-md text-muted mb-3"><b>9. Modifications to This Privacy Policy.</b> This Privacy Statement may be changed at any moment for any reason. We shall post the revised Privacy Policy to alert you of any changes to our Privacy Policy. The date the Privacy Policy was last changed is noted at the top of this document. You are responsible for checking our Service and this Privacy Policy for changes on a regular basis.</p>
                        </div>

                        <div className='mb-4'>
                            <p className="text-md text-muted mb-3"><b>10. Questions; Contacting Us; Reporting Violations.</b> If you have any questions or concerns or complaints about our Privacy Policy or our data collection or processing practices, or if you want to report any security violations to us, please contact us through the information provided on our <NavLink to='/contact'>Contact Us page</NavLink>. </p>
                        </div>
                    </div>
                </div>
            </section>
